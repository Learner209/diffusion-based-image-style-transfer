...
def get_parser(**parser_kwargs):
    ...
    parser.add_argument(
        ...
        type=str,
        nargs="?",
        default="/mnt/homes/minghao/AI/final_project/src/pretrained_weights/sd-v1-4-full-ema.ckpt",
    ...
    parser.add_argument(
        ...
        "--base",
        nargs="*",
        default="/mnt/homes/minghao/AI/final_project/src/configs/stable-diffusion/mural.yaml",
